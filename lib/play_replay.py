...
flags.DEFINE_integer("step_mul", 4, "Game steps per observation.")
...
flags.DEFINE_string("replay", "D:/sc2/multi_agent/init/data/36replays/Simple64_2018-04-06-13-36-21.SC2Replay",
                    "Name of a replay to show.")
